...
def test_get_mask_card_number_invalid_length(card_number: int, expected_result: str) -> None:
...
def test_get_mask_account(account_number: int, expected_result: str) -> None:
...
def test_get_mask_account_invalid_length(account_number: int, expected_result: str) -> None:
